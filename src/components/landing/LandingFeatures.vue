<template>
  <section class="bg-gray-50 dark:bg-gray-800" id="features">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:py-20 lg:px-6">
      <div class="flex flex-col items-center text-center">
        <h2 class="mb-4 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">Fonctionnalités de PreviewFast</h2>
        <p class="text-gray-500 dark:text-gray-400 sm:text-xl">
          Imports intelligents, templates premium et export HD réunis dans un seul flow pour vos équipes marketing.
        </p>
      </div>
      <div class="space-y-10 pt-12 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <article v-for="feature in features" :key="feature.title">
          <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/40">
            <svg class="h-6 w-6 text-blue-600 dark:text-blue-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path :d="feature.iconPath" fill-rule="evenodd" clip-rule="evenodd"></path>
            </svg>
          </div>
          <h3 class="mb-2 text-xl font-semibold text-gray-900 dark:text-white">{{ feature.title }}</h3>
...
const features = [
  {
    ...
    description: 'Glissez vos captures, PreviewFast les adapte automatiquement au mockup sélectionné.',
    iconPath:
  ...
  },
  {
    ...
    description: 'Bibliothèque iOS & Android inspirée des meilleurs shots dribbble, prête à l’emploi.',
    iconPath:
  ...
  {
    title: 'Bloc texte express',
    description: 'Sélectionnez un modèle copywriting, personnalisez typo & alignement en un clic.',
    iconPath:
  ...
  {
    title: 'Historique auto',
    description: 'Retrouvez vos dernières variations pour itérer plus vite avec votre équipe.',
    iconPath:
  ...
  {
    title: 'Rappels partagés',
    description: 'Recevez une notification quand il est temps d’envoyer vos visuels clients.',
    iconPath:
      'M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762z'
  },
  {
    title: 'Export HD',
    description: 'dom-to-image-more génère des PNG 2x impeccables sans quitter le navigateur.',
    iconPath:
